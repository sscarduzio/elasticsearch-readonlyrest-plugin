...
class TransportRRUserMetadataAction(settings: Settings,
  ...
  extends HandledTransportAction[RRUserMetadataRequest, RRUserMetadataResponse](
    settings, RRUserMetadataActionType.name, threadPool, transportService, actionFilters, indexNameExpressionResolver, () => new RRUserMetadataRequest(UriPath.userMetadataPath, None)
  ) {
