...
class RorWrappedCatActionType
    extends Action[RorWrappedCatRequest, RorWrappedCatResponse, RorWrappedCatActionType.RequestBuilder](
...
object RorWrappedCatActionType {
  ...
  class RequestBuilder(client: ElasticsearchClient, actionType: RorWrappedCatActionType, request: RorWrappedCatRequest)
      extends ActionRequestBuilder[RorWrappedCatRequest, RorWrappedCatResponse, RequestBuilder](
        client,
        actionType,
        request
      )
