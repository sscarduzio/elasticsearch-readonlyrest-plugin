...
class PromoteDataStreamEsRequestContext(actionRequest: PromoteDataStreamAction.Request,
  ...
  override def indicesFrom(request: PromoteDataStreamAction.Request): Set[domain.ClusterIndexName] = originIndices

  override def update(request: PromoteDataStreamAction.Request,
