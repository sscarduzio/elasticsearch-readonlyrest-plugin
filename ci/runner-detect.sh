...
# True in the Git Bash of a windows-2025 runner. The integration legs run the same script there,
# and three things differ: gradle provisions its own JDKs, the runner-side gradle cache is worth
# reading, and there is no setsid.
is_windows() {
  case "$(uname -s)" in
