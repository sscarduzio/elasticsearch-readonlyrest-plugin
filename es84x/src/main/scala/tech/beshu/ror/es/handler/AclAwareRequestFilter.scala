...
import tech.beshu.ror.es.handler.request.context.types.datastreams.{CreateDataStreamEsRequestContext, DataStreamsStatsEsRequestContext, DeleteDataStreamEsRequestContext, GetDataStreamEsRequestContext, MigrateToDataStreamEsRequestContext, ModifyDataStreamsEsRequestContext, PromoteDataStreamEsRequestContext}
