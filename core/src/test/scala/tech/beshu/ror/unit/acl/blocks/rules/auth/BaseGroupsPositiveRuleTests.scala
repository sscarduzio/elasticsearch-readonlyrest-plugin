...
trait BaseGroupsPositiveRuleTests extends AnyWordSpecLike with Inside with BlockContextAssertion {
  ...
  implicit val logicResolverCreator: ResolvableGroupIds => GroupsLogicResolver
