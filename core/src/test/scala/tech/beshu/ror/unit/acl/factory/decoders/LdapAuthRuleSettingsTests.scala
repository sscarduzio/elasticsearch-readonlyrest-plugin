...
import tech.beshu.ror.acl.blocks.rules.{ImpersonationRuleDecorator, LdapAuthRule}
...
class LdapAuthRuleSettingsTests
  extends BaseRuleSettingsDecoderTest[ImpersonationRuleDecorator[LdapAuthRule]]
