...
class AuthKeySha256RuleTests extends BasicAuthenticationTestTemplate {
  ...
  override protected val rule = new AuthKeySha256Rule(BasicAuthenticationRule.Settings(
    HashedUserAndPassword("280ac6f756a64a80143447c980289e7e4c6918b92588c8095c7c3f049a13fbf9".nonempty)
  ))
}
