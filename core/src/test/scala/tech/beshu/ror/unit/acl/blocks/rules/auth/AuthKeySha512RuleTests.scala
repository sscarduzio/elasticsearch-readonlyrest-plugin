...
class AuthKeySha512RuleAltSyntaxTests
  ...
  override protected def ruleCreator: Impersonation => BasicAuthenticationRule[_] = impersonation =>
    new AuthKeySha512Rule(
      BasicAuthenticationRule.Settings(
        HashedOnlyPassword(
          User.Id("logstash"),
          "2963e577145fb7f675c6726800691b3432020f8373cc5a3e8b30ca0856047846d10c96b7cfe64ed750637e09d7266e6eb464628995eed5368ef4780868f230ea"
        )
      ),
      CaseSensitivity.Enabled,
      impersonation
