...
class GlobalSettingsTests extends BaseDecoderTest(GlobalSettingsTests.decoder) {
        ...
        "enabled" in {
          assertDecodingSuccess(
            yaml = s"""
               ...
               """.stripMargin,
            assertion = settings => settings.showBasicAuthPrompt should be(true)
          )
        }
        "disabled" in {
          assertDecodingSuccess(
            yaml = s"""
               ...
               """.stripMargin,
            assertion = settings => settings.showBasicAuthPrompt should be(false)
          )
        }
        "not defined" in {
          assertDecodingSuccess(
        ...
        "custom message" in {
          assertDecodingSuccess(
            yaml = s"""
               ...
               """.stripMargin,
            assertion = settings => settings.forbiddenRequestMessage should be("custom_forbidden_response")
          )
        }
        "not defined" in {
          assertDecodingSuccess(
            yaml = noCustomSettingsYaml,
            assertion = settings => settings.forbiddenRequestMessage should be("Forbidden by ReadonlyREST")
          )
        }
      }
    }
        ...
        "lucene" in {
          assertDecodingSuccess(
            yaml = s"""
                      ...
                      |   fls_engine: lucene
               """.stripMargin,
            assertion = settings => settings.flsEngine should be(FlsEngine.Lucene)
          )
        }
        "es_with_lucene" in {
          assertDecodingSuccess(
            yaml = s"""
               ...
               """.stripMargin,
            assertion = settings => settings.flsEngine should be(FlsEngine.ESWithLucene)
          )
        }
        "es" in {
          assertDecodingSuccess(
            yaml = s"""
                      ...
                      |   fls_engine: es
               """.stripMargin,
            assertion = settings => settings.flsEngine should be(FlsEngine.ES)
          )
        }
        "not defined" in {
          assertDecodingSuccess(
            ...
            assertion = error =>
              error should be(
                GeneralReadonlyrestSettingsError(
                  Message("Unknown fls engine: 'custom'. Supported: 'es_with_lucene'(default), 'es'.")
                )
              )
          )
        }
        ...
        "case sensitive" in {
          assertDecodingSuccess(
            yaml = s"""
               ...
               """.stripMargin,
            assertion = settings => settings.userIdCaseSensitivity should be(CaseSensitivity.Enabled)
          )
        }
        "case insensitive" in {
          assertDecodingSuccess(
            yaml = s"""
               ...
               """.stripMargin,
            assertion = settings => settings.userIdCaseSensitivity should be(CaseSensitivity.Disabled)
          )
        }
        "no defined" in {
          assertDecodingSuccess(
        ...
        "enabled" in {
          assertDecodingSuccess(
            yaml = s"""
                     ...
                     """.stripMargin,
            assertion = settings => settings.usersDefinitionDuplicateUsernamesValidationEnabled should be(true)
          )
        }
        "disabled" in {
          assertDecodingSuccess(
            yaml = s"""
                     ...
                     """.stripMargin,
            assertion = settings => settings.usersDefinitionDuplicateUsernamesValidationEnabled should be(false)
          )
        }
        "no defined" in {
          assertDecodingSuccess(
