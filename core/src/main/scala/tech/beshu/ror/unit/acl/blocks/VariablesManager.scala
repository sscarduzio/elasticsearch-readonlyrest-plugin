...
import tech.beshu.ror.unit.acl.blocks.VariablesManager._
import tech.beshu.ror.unit.acl.request.RequestContext
import tech.beshu.ror.utils.TemplateReplacer
...
class VariablesManager(requestContext: RequestContext)
  ...
  private val templateReplacer = new TemplateReplacer(escapeChar, delimiterBeginChar, delimiterEndChar)
