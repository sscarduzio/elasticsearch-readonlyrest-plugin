...
object BlockContext {
  ...
  final case class UserMetadataRequestBlockContext(
      override val block: Block,
      override val requestContext: RequestContext,
      override val blockMetadata: BlockMetadata,
      override val responseHeaders: Set[Header],
      override val responseTransformations: List[ResponseTransformation]
  ) extends BlockContext

  final case class GeneralNonIndexRequestBlockContext(
      override val block: Block,
      override val requestContext: RequestContext,
      override val blockMetadata: BlockMetadata,
      override val responseHeaders: Set[Header],
  ...
  final case class RepositoryRequestBlockContext(
      override val block: Block,
      override val requestContext: RequestContext,
      override val blockMetadata: BlockMetadata,
      override val responseHeaders: Set[Header],
  ...
  final case class SnapshotRequestBlockContext(
      override val block: Block,
      override val requestContext: RequestContext,
      override val blockMetadata: BlockMetadata,
      override val responseHeaders: Set[Header],
  ...
  final case class DataStreamRequestBlockContext(
      override val block: Block,
      override val requestContext: RequestContext,
      override val blockMetadata: BlockMetadata,
      override val responseHeaders: Set[Header],
  ...
  object DataStreamRequestBlockContext {
    ...
    object BackingIndices {
      ...
      final case class IndicesInvolved(
          filteredIndices: Set[RequestedIndex[ClusterIndexName]],
          allAllowedIndices: Set[ClusterIndexName]
      ) extends BackingIndices
  ...
  final case class AliasRequestBlockContext(
      override val block: Block,
      override val requestContext: RequestContext,
      override val blockMetadata: BlockMetadata,
      override val responseHeaders: Set[Header],
  ...
  final case class TemplateRequestBlockContext(
      override val block: Block,
      override val requestContext: RequestContext,
      override val blockMetadata: BlockMetadata,
      override val responseHeaders: Set[Header],
  ...
  final case class GeneralIndexRequestBlockContext(
      override val block: Block,
      override val requestContext: RequestContext,
      override val blockMetadata: BlockMetadata,
      override val responseHeaders: Set[Header],
  ...
  final case class FilterableRequestBlockContext(
      override val block: Block,
      override val requestContext: RequestContext,
      override val blockMetadata: BlockMetadata,
      override val responseHeaders: Set[Header],
  ...
  final case class FilterableMultiRequestBlockContext(
      override val block: Block,
      override val requestContext: RequestContext,
      override val blockMetadata: BlockMetadata,
      override val responseHeaders: Set[Header],
  ...
  final case class MultiIndexRequestBlockContext(
      override val block: Block,
      override val requestContext: RequestContext,
      override val blockMetadata: BlockMetadata,
      override val responseHeaders: Set[Header],
  ...
  final case class RorApiRequestBlockContext(
      override val block: Block,
      override val requestContext: RequestContext,
      override val blockMetadata: BlockMetadata,
      override val responseHeaders: Set[Header],
  ...
  object HasIndices {
    ...
    def apply[B <: BlockContext](
        implicit instance: HasIndices[B]
    ): HasIndices[B] = instance
  ...
  object HasIndexPacks {
    ...
    def apply[B <: BlockContext](
        implicit instance: HasIndexPacks[B]
    ): HasIndexPacks[B] = instance

    implicit val indexPacksFromFilterableMultiBlockContext: HasIndexPacks[FilterableMultiRequestBlockContext] =
      new HasIndexPacks[FilterableMultiRequestBlockContext] {
        override def indexPacks(blockContext: FilterableMultiRequestBlockContext): List[Indices] =
          blockContext.indexPacks
      }

    implicit val indexPacksFromMultiIndexBlockContext: HasIndexPacks[MultiIndexRequestBlockContext] =
      new HasIndexPacks[MultiIndexRequestBlockContext] {
  ...
  object HasFilter {
    ...
    def apply[B <: BlockContext](
        implicit instance: HasFilter[B]
    ): HasFilter[B] = instance

    implicit val filterFromFilterableMultiBlockContext: HasFilter[FilterableMultiRequestBlockContext] =
      new HasFilter[FilterableMultiRequestBlockContext] {
        override def filter(blockContext: FilterableMultiRequestBlockContext): Option[Filter] = blockContext.filter
      }

    implicit val filterFromFilterableRequestBlockContext: HasFilter[FilterableRequestBlockContext] =
      new HasFilter[FilterableRequestBlockContext] {
  ...
  object HasFieldLevelSecurity {
    ...
    def apply[B <: BlockContext](
        implicit instance: HasFieldLevelSecurity[B]
    ): HasFieldLevelSecurity[B] = instance

    implicit val flsFromFilterableMultiBlockContext: HasFieldLevelSecurity[FilterableMultiRequestBlockContext] =
      new HasFieldLevelSecurity[FilterableMultiRequestBlockContext] {
        override def fieldLevelSecurity(blockContext: FilterableMultiRequestBlockContext): Option[FieldLevelSecurity] =
          blockContext.fieldLevelSecurity
      }

    implicit val flsFromFilterableRequestBlockContext: HasFieldLevelSecurity[FilterableRequestBlockContext] =
      new HasFieldLevelSecurity[FilterableRequestBlockContext] {
        override def fieldLevelSecurity(blockContext: FilterableRequestBlockContext): Option[FieldLevelSecurity] =
          blockContext.fieldLevelSecurity
      }
  ...
  object AllowsFieldsInRequest {
    ...
    def apply[B <: BlockContext](
        implicit instance: AllowsFieldsInRequest[B]
    ): AllowsFieldsInRequest[B] = instance

    implicit val fieldsFromFilterableMultiBlockContext: AllowsFieldsInRequest[FilterableMultiRequestBlockContext] =
      new AllowsFieldsInRequest[FilterableMultiRequestBlockContext] {
        override def requestFieldsUsage(blockContext: FilterableMultiRequestBlockContext): RequestFieldsUsage =
          blockContext.requestFieldsUsage
      }

    implicit val fieldsFromFilterableRequestBlockContext: AllowsFieldsInRequest[FilterableRequestBlockContext] =
      new AllowsFieldsInRequest[FilterableRequestBlockContext] {
        override def requestFieldsUsage(blockContext: FilterableRequestBlockContext): RequestFieldsUsage =
          blockContext.requestFieldsUsage
      }
  ...
  implicit class BlockContextUpdaterOps[B <: BlockContext: BlockContextUpdater](val blockContext: B) {
    def withBlockMetadata(update: BlockMetadata => BlockMetadata): B =
      BlockContextUpdater[B].withBlockMetadata(blockContext, update(blockContext.blockMetadata))
  ...
  implicit class RepositoryOperationBlockContextUpdaterOps(val blockContext: RepositoryRequestBlockContext)
      extends AnyVal {
  ...
  implicit class DataStreamOperationBlockContextUpdateOps(val blockContext: DataStreamRequestBlockContext)
      extends AnyVal {
  ...
  implicit class BlockContextWithIndexPacksUpdaterOps[B <: BlockContext: BlockContextWithIndexPacksUpdater](
      blockContext: B
  ) {
  ...
  implicit class TemplateRequestBlockContextUpdaterOps(val blockContext: TemplateRequestBlockContext) extends AnyVal {
    ...
    def withResponseTemplateTransformation(
        transformation: Set[Template] => Set[Template]
    ): TemplateRequestBlockContext = {
  ...
  implicit class IndicesFromBlockContext(val blockContext: BlockContext) extends AnyVal {
    ...
    def indices: Set[RequestedIndex[ClusterIndexName]] = {
      blockContext match {
        case _: UserMetadataRequestBlockContext    => Set.empty
  ...
  implicit class TemplatesFromBlockContext(val blockContext: BlockContext) extends AnyVal {
    ...
    def templateOperation: Option[TemplateOperation] = {
      blockContext match {
        case _: UserMetadataRequestBlockContext    => None
  ...
  implicit class RandomIndexBasedOnBlockContextIndices[B <: BlockContext: HasIndices](blockContext: B) {
    ...
    def randomNonexistentLocalIndex(
        fromIndices: B => Iterable[RequestedIndex[ClusterIndexName]]
    ): RequestedIndex[ClusterIndexName.Local] = {
  ...
  implicit class InvolvesIndices(val b: BlockContext) extends AnyVal {
    ...
    def involvesIndices: Boolean = b match {
      case _: UserMetadataRequestBlockContext    => hasIndices[UserMetadataRequestBlockContext]
    ...
    private def hasIndices[B <: BlockContext](
        implicit hasIndices: Option[HasIndices[B]] = None,
