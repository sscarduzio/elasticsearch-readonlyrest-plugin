...
object VariableContext {
  ...
  object VariableUsage {
    ...
    implicit val pkiAuthenticationRule: VariableUsage[PkiAuthenticationRule] = NotUsingVariable()
    implicit val pkiAuthorizationRule: VariableUsage[PkiAuthorizationRule] = NotUsingVariable()
    implicit val pkiAuthRule: VariableUsage[PkiAuthRule] = NotUsingVariable()
