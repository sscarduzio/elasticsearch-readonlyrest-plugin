...
object BlockContextUpdater {
  ...
  def apply[B <: BlockContext](
      implicit instance: BlockContextUpdater[B]
  ): BlockContextUpdater[B] = instance

  implicit object UserMetadataRequestBlockContextUpdater extends BlockContextUpdater[UserMetadataRequestBlockContext] {
  ...
  implicit object GeneralNonIndexRequestBlockContextUpdater
    ...
    override def emptyBlockContext(
        blockContext: GeneralNonIndexRequestBlockContext
  ...
  implicit object RepositoryRequestBlockContextUpdater extends BlockContextUpdater[RepositoryRequestBlockContext] {
  ...
  implicit object SnapshotRequestBlockContextUpdater extends BlockContextUpdater[SnapshotRequestBlockContext] {
  ...
  implicit object DataStreamRequestBlockContextUpdater extends BlockContextUpdater[DataStreamRequestBlockContext] {
    ...
    override def emptyBlockContext(blockContext: DataStreamRequestBlockContext): DataStreamRequestBlockContext =
      DataStreamRequestBlockContext(
        ...
        List.empty,
        Set.empty,
        DataStreamRequestBlockContext.BackingIndices.IndicesNotInvolved
      )
  ...
  implicit object TemplateRequestBlockContextUpdater extends BlockContextUpdater[TemplateRequestBlockContext] {
    ...
    override def emptyBlockContext(blockContext: TemplateRequestBlockContext): TemplateRequestBlockContext =
      TemplateRequestBlockContext(
        ...
        Set.empty,
        List.empty,
        blockContext.templateOperation,
        identity,
        Set.empty
      )
  ...
  implicit object AliasRequestBlockContextUpdater extends BlockContextUpdater[AliasRequestBlockContext] {
    ...
    override def withBlockMetadata(
        blockContext: AliasRequestBlockContext,
        blockMetadata: BlockMetadata
    ): AliasRequestBlockContext =
      blockContext.copy(blockMetadata = blockMetadata)
  ...
  implicit object GeneralIndexRequestBlockContextUpdater extends BlockContextUpdater[GeneralIndexRequestBlockContext] {
  ...
  implicit object MultiIndexRequestBlockContextUpdater extends BlockContextUpdater[MultiIndexRequestBlockContext] {

    override def emptyBlockContext(blockContext: MultiIndexRequestBlockContext): MultiIndexRequestBlockContext =
      MultiIndexRequestBlockContext(
        blockContext.block,
        blockContext.requestContext,
        BlockMetadata.empty,
        Set.empty,
    ...
    override def withBlockMetadata(
        blockContext: MultiIndexRequestBlockContext,
        blockMetadata: BlockMetadata
    ): MultiIndexRequestBlockContext =
      blockContext.copy(blockMetadata = blockMetadata)
  ...
  implicit object FilterableRequestBlockContextUpdater extends BlockContextUpdater[FilterableRequestBlockContext] {
  ...
  implicit object RorApiRequestBlockContextUpdater extends BlockContextUpdater[RorApiRequestBlockContext] {
    ...
    override def withBlockMetadata(
        blockContext: RorApiRequestBlockContext,
        blockMetadata: BlockMetadata
    ): RorApiRequestBlockContext =
      blockContext.copy(blockMetadata = blockMetadata)
...
abstract class BlockContextWithIndicesUpdater[B <: BlockContext: HasIndices] {
  ...
  def withClusters(blockContext: B, allAllowedClusters: Set[ClusterName.Full]): B = blockContext
}

object BlockContextWithIndicesUpdater {

  def apply[B <: BlockContext](
      implicit ev: BlockContextWithIndicesUpdater[B]
  ) = ev
  ...
  implicit object DataStreamRequestBlocContextWithIndicesUpdater
    ...
    def withIndices(
      ...
      blockContext.copy(backingIndices =
        DataStreamRequestBlockContext.BackingIndices.IndicesInvolved(
...
object BlockContextWithIndexPacksUpdater {
  ...
  def apply[B <: BlockContext](
      implicit ev: BlockContextWithIndexPacksUpdater[B]
  ) = ev
...
object BlockContextWithFilterUpdater {
  ...
  def apply[B <: BlockContext](
      implicit ev: BlockContextWithFilterUpdater[B]
  ) = ev
  ...
  implicit object FilterableBlockContextWithFilterUpdater
    ...
    def withFilter(blockContext: FilterableRequestBlockContext, filter: Filter): FilterableRequestBlockContext =
      blockContext.copy(filter = Some(filter))
  }
...
object BlockContextWithFLSUpdater {
  ...
  def apply[B <: BlockContext](
      implicit ev: BlockContextWithFLSUpdater[B]
  ) = ev
