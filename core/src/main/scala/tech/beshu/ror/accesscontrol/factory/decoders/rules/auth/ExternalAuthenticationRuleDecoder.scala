...
import tech.beshu.ror.accesscontrol.factory.decoders.definitions.ExternalAuthenticationServicesDecoder.*
    ...
    SyncDecoderCreator
      .instance { c =>
        for {
          ...
          ttl <- c.downFieldAlternatives("cache_ttl_in_sec", "cache_ttl").as[PositiveFiniteDuration]
