...
import tech.beshu.ror.accesscontrol.domain.{AuditOutputName, RequestId}
import tech.beshu.ror.audit.AuditResponseContext

private[audit] abstract class JsonBasedAuditOutput(val name: AuditOutputName, auditSerializer: JsonAuditSerializer)
    extends AuditOutput {
