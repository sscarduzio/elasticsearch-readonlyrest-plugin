...
class KibanaIndexRuleDecoder(variableCreationConfig: VariableCreationConfig)
...
class KibanaTemplateIndexRuleDecoder(variableCreationConfig: VariableCreationConfig)
