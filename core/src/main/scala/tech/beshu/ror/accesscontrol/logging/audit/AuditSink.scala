...
private[audit] abstract class AuditSink(auditLogSerializer: AuditLogSerializer) {
  ...
  protected def submit(event: AuditResponseContext, serializedEvent: JSONObject): Unit
