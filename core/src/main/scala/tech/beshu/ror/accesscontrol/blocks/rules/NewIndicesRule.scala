...
//import tech.beshu.ror.accesscontrol.blocks.{BlockContext, DirectIndexOperationBlockContext, IndirectIndexOperationBlockContext, NonIndexOperationBlockContext}
...
//
//  def check2[O <: Operation]( blockContext: BlockContext[O, _]): Task[RuleResult[O]] = {
//    blockContext match {
//      case value: NonIndexOperationBlockContext[_, _] =>
//      case value: IndirectIndexOperationBlockContext[_, _] =>
//        value.withLoggedUser(null);
//      case value: DirectIndexOperationBlockContext[_, _] =>
//        value.filteredIndices(Nil)
//    }
//    ???
//  }
//
...
////        case context: NonIndexOperationRequestContext[_] =>
////          Task.now(Fulfilled(blockContext))
////        case context: DirectIndexOperationRequestContext[_] =>
////          ///Task.now(Fulfilled(blockContext.modifyOperation(FilterIndices( Set.empty))))
////          ???
////        case value: IndirectIndexOperationRequestContext[_] =>
...
//      case get: TemplateOperation.Get => ???
//      case create: TemplateOperation.Create => CanPass.No()
//      case delete: TemplateOperation.Delete => CanPass.No()
//    }
//  }
//
...
//      case get: TemplateOperation.Get => get.templates.flatMap(indexNamesFrom(_).toNonEmptyList).toList.toSet
//      case create: TemplateOperation.Create => indexNamesFrom(create.template).toSortedSet
//      case delete: TemplateOperation.Delete => indexNamesFrom(delete.template).toSortedSet
//    }
//
...
//    def indices: Set[IndexName] = operation match {
//      case genetal: GeneralIndexOperation => genetal.indices
//      case sql: SqlOperation => sql.tables.flatMap(_.indices.toList).toSet
//    }
//  }
//}