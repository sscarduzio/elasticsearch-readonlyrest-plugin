    ...
    AccessController.doPrivileged((PrivilegedAction<Void>) () -> {
      try {
        ...
        if (connectionConfig.isSslEnabled()) {
          ...
          connection = new SingleServerSet(connectionConfig.getHost(), connectionConfig.getPort(), sslSocketFactory, options).getConnection();
        }
        else {
          connection = new SingleServerSet(connectionConfig.getHost(), connectionConfig.getPort(), options).getConnection();
        }
        connection.connect(
