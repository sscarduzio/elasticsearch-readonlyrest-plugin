 ...
 */
public class __old_GroupsAsyncRule extends AsyncRule implements Authorization, Authentication {
  ...
  public CompletableFuture<RuleExitResult> match(__old_RequestContext rc) {
    ...
    List<__old_UserSettings> userSettingsToCheck = settings.getUsersSettings();
