...
import tech.beshu.ror.integration.suites.base.BaseSqlApiSuite
...
class SqlApiWithRorWithEnabledXpackSecuritySuite extends BaseSqlApiSuite {

  override implicit lazy val rorSettingsFileName: String = "/sql_api/readonlyrest_without_ror_ssl.yml"
