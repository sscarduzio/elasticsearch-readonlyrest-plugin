...
class SqlApiWithRorWithDisabledXpackSecuritySuite extends BaseSqlApiSuite {

  override implicit val rorSettingsFileName: String = "/sql_api/readonlyrest_with_ror_ssl.yml"
