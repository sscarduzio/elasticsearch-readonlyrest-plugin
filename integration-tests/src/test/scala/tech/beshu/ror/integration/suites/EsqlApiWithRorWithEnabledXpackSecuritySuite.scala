...
import tech.beshu.ror.integration.suites.base.BaseEsqlApiSuite
...
class EsqlApiWithRorWithEnabledXpackSecuritySuite extends BaseEsqlApiSuite {

  override implicit lazy val rorSettingsFileName: String = "/esql_api/readonlyrest_without_ror_ssl.yml"
