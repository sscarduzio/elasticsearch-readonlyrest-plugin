...
trait BaseAdminApiAuthMockSuite
  ...
  protected def esCluster: EsClusterContainer

  protected def readonlyrestIndexName: String

  protected def resolvedRorConfig: String
  ...
  private val testEngineReloadInterval = 5 seconds
  ...
  private def testEngineConfig(): String = resolvedRorConfig

  override implicit val patienceConfig: PatienceConfig = PatienceConfig(timeout = testEngineReloadInterval.plus(5 second), interval = 1 second)
