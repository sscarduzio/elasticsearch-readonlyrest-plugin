...
class EsqlApiWithRorWithDisabledXpackSecuritySuite extends BaseEsqlApiSuite {

  override implicit val rorSettingsFileName: String = "/esql_api/readonlyrest_with_ror_ssl.yml"
