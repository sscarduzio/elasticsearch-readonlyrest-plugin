...
import tech.beshu.ror.utils.elasticsearch.LegacyTemplateManager
...
trait IndexTemplatesManagementSuite
  ...
  private lazy val dev1TemplateManager = new LegacyTemplateManager(basicAuthClient("dev1", "test"), esTargets.head.esVersion)
  private lazy val dev2TemplateManager = new LegacyTemplateManager(basicAuthClient("dev2", "test"), esTargets.head.esVersion)
    ...
    "user is dev1" should {
        ...
        "there is no index defined for it" when {
          "template has index pattern with wildcard" when {
            "rule has index pattern with wildcard" in {
              ...
              templates.responseCode should be(200)
              templates.templates should be(List(LegacyTemplateManager.Template("temp1", Set("custom_dev1_*"), Set("dev1_index"))))
            }
            "rule has index pattern with no wildcard" in {
              ...
              templates.responseCode should be(200)
              templates.templates should be(List(LegacyTemplateManager.Template("temp1", Set("dev1_*"), Set.empty)))
            }
          }
          "template has index pattern with no wildcard" when {
            "rule has index pattern with wildcard" in {
              ...
              templates.responseCode should be(200)
              templates.templates should be(List(LegacyTemplateManager.Template("temp1", Set("custom_dev1_index_test"), Set.empty)))
            }
            "rule has index pattern with no wildcard" in {
              adminTemplateManager.insertTemplateAndWaitForIndexing(
                templateName = "temp1",
              ...
              templates.responseCode should be(200)
              templates.templates should be(List(LegacyTemplateManager.Template("temp1", Set("dev1_index"), Set.empty)))
            }
          }
        }
        "there is an index defined for it" when {
          "template has index pattern with wildcard" when {
            "rule has index pattern with wildcard" in {
              ...
              templates.responseCode should be(200)
              templates.templates should be(List(LegacyTemplateManager.Template("temp1", Set("custom_dev1_*"), Set.empty)))
            }
            "rule has index pattern with no wildcard" in {
              adminTemplateManager.insertTemplateAndWaitForIndexing(
                templateName = "temp1",
      ...
      "be allowed to create new template" when {
        ...
        "template applies to generic index pattern (ES >= 6.0.0)" excludeES (allEs5x) in {
          ...
          user1Template.templates should be(List(LegacyTemplateManager.Template("new_template", Set("custom_dev1_index_*"), Set.empty)))
        }
      ...
      "be allowed to override existing template" which {
        "belongs to him" in {
          ...
          user1Template.responseCode should be(200)
          user1Template.templates should be(List(LegacyTemplateManager.Template("new_template", Set("custom_dev1_index_test*"), Set.empty)))
          ...
          user1TemplateAfterOverride.templates should be(List(LegacyTemplateManager.Template("new_template", Set("dev1_index"), Set.empty)))
        }
      }
    ...
    "user is dev3" should {
      "be allowed to remove his template" when {
        "he previously added it (because it was allowed by block with no indices rule)" in {
          val dev3TemplateManager = new LegacyTemplateManager(basicAuthClient("dev3", "test"), esTargets.head.esVersion)
