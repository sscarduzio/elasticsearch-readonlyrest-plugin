...
final class NodeClientBasedAuditOutputService(
  ...
  private val bulkProcessor =
    BulkProcessor2
      .builder(BulkRequestHandler, new AuditOutputBulkProcessorListener, threadPool)
      .setBulkActions(AUDIT_OUTPUT_MAX_ITEMS)
      .setBulkSize(ByteSizeValue.of(AUDIT_OUTPUT_MAX_KB, ByteSizeUnit.KB))
  ...
  private class AuditOutputBulkProcessorListener extends BulkProcessor2.Listener {
