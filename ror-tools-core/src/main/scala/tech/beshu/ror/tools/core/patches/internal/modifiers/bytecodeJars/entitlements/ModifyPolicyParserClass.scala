...
private[patches] object ModifyPolicyParserClass extends BytecodeJarModifier {
  ...
  private object UpgradeIfRorPolicyNameMethod {
    ...
    def create(classVisitor: ClassVisitor): Unit = {
      val methodVisitor = classVisitor.visitMethod(
        Opcodes.ACC_PRIVATE,
        "upgradeIfRorPolicyName",
        "(Ljava/lang/String;Lorg/elasticsearch/entitlement/runtime/policy/Scope;)Lorg/elasticsearch/entitlement/runtime/policy/Scope;",
        null,
        null
      )
      ...
      methodVisitor.visitMethodInsn(
        ...
        "org/elasticsearch/entitlement/runtime/policy/Scope",
        "moduleName",
        "()Ljava/lang/String;",
        false
      )
      ...
      methodVisitor.visitTypeInsn(
        Opcodes.NEW,
        "org/elasticsearch/entitlement/runtime/policy/entitlements/CreateClassLoaderEntitlement"
      )
      methodVisitor.visitInsn(Opcodes.DUP)
      methodVisitor.visitMethodInsn(
        Opcodes.INVOKESPECIAL,
      ...
      methodVisitor.visitLocalVariable(
        ...
        "Ljava/util/List;",
        "Ljava/util/List<Lorg/elasticsearch/entitlement/runtime/policy/entitlements/Entitlement;>;",
        label3,
        label1,
        3
      )
      methodVisitor.visitLocalVariable(
        "this",
        "Lorg/elasticsearch/entitlement/runtime/policy/PolicyParser;",
        null,
        label0,
        label5,
        0
      ...
      methodVisitor.visitLocalVariable(
        "scope",
        "Lorg/elasticsearch/entitlement/runtime/policy/Scope;",
        null,
        label0,
        label5,
        2
  ...
  private class RorScopeUpgradedParsePolicyMethod(underlying: MethodVisitor) extends MethodVisitor(Opcodes.ASM9) {
    ...
    override def visitCode(): Unit = {
      ...
      underlying.visitMethodInsn(
        ...
        "nextToken",
        "()Lorg/elasticsearch/xcontent/XContentParser$Token;",
        true
      )
      underlying.visitFieldInsn(
        Opcodes.GETSTATIC,
      ...
      underlying.visitMethodInsn(
        ...
        "(Ljava/lang/String;)Lorg/elasticsearch/entitlement/runtime/policy/PolicyParserException;",
        false
      )
      ...
      underlying.visitMethodInsn(
        ...
        "org/elasticsearch/entitlement/runtime/policy/PolicyParser",
        "parseScope",
        "(Ljava/lang/String;)Lorg/elasticsearch/entitlement/runtime/policy/Scope;",
        false
      )
      underlying.visitMethodInsn(
        Opcodes.INVOKEVIRTUAL,
      ...
      underlying.visitMethodInsn(
        Opcodes.INVOKESPECIAL,
        "org/elasticsearch/entitlement/runtime/policy/Policy",
        "<init>",
        "(Ljava/lang/String;Ljava/util/List;)V",
        false
      )
      ...
      underlying.visitLocalVariable(
        "scopes",
        "Ljava/util/List;",
        "Ljava/util/List<Lorg/elasticsearch/entitlement/runtime/policy/Scope;>;",
        label5,
        label2,
        1
      )
