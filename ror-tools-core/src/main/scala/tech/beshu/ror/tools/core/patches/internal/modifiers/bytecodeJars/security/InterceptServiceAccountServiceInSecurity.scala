...
private [patches] object CreateRorServiceAccountServiceBridgeInSecurity extends BytecodeJarModifier {
    ...
    override def visitMethod(access: Int,
      ...
      name match {
        case "createComponents" if (access & Opcodes.ACC_PUBLIC) != 0 =>
          new InterceptServiceAccountServiceInCreateComponentsMethod(
  ...
  private class InterceptServiceAccountServiceInCreateComponentsMethod(underlying: MethodVisitor)
