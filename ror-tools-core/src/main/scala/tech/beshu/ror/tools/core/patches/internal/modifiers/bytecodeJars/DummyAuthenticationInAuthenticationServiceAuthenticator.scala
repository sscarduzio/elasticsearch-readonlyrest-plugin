  ...
  private class EsClassVisitor(writer: ClassWriter)
    ...
    private class SetXpackUserAsAuthenticatedUserInAuthenticateAsyncMethod(underlying: MethodVisitor)
      ...
      override def visitCode(): Unit = {
        ...
        underlying.visitLdcInsn("__attach")
        underlying.visitVarInsn(Opcodes.ALOAD, 0)
        underlying.visitFieldInsn(Opcodes.GETFIELD, "org/elasticsearch/xpack/security/authc/AuthenticationService$Authenticator", "this$0", "Lorg/elasticsearch/xpack/security/authc/AuthenticationService;")
        underlying.visitMethodInsn(Opcodes.INVOKESTATIC, "org/elasticsearch/xpack/security/authc/AuthenticationService", "access$600", "(Lorg/elasticsearch/xpack/security/authc/AuthenticationService;)Ljava/lang/String;", false)
        ...
        underlying.visitLocalVariable("this", "Lorg/elasticsearch/xpack/security/authc/AuthenticationService$Authenticator;", null, label0, label3, 0)
    ...
    private class SetXpackUserAsAuthenticatedUserInConsumeToken(underlying: MethodVisitor)
      ...
      override def visitCode(): Unit = {
        ...
        underlying.visitLabel(label3)
        underlying.visitLocalVariable("this", "Lorg/elasticsearch/xpack/security/authc/AuthenticationService$Authenticator;", null, label0, label3, 0)
        underlying.visitLocalVariable("token", "Lorg/elasticsearch/xpack/core/security/authc/AuthenticationToken;", null, label0, label3, 1)
