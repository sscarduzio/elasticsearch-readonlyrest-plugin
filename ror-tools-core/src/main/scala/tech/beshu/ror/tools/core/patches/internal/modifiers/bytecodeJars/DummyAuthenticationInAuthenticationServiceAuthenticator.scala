  ...
  private class EsClassVisitor(writer: ClassWriter)
    ...
    private class SetXpackUserAsAuthenticatedUserInAuthenticateAsyncMethod(underlying: MethodVisitor)
      ...
      override def visitCode(): Unit = {
        ...
        underlying.visitJumpInsn(Opcodes.IFNULL, label7)
        ...
        underlying.visitJumpInsn(Opcodes.GOTO, label10)
        ...
        underlying.visitLocalVariable("e", "Ljava/lang/Exception;", null, label5, label4, 2)
        underlying.visitLocalVariable("this", "Lorg/elasticsearch/xpack/security/authc/AuthenticationService$Authenticator;", null, label3, label12, 0)
