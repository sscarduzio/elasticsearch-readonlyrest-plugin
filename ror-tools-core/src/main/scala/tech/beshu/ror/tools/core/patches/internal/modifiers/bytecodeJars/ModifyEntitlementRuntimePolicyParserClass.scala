...
private [patches] object ModifyEntitlementRuntimePolicyParserClass extends BytecodeJarModifier {
  ...
  private class EsClassVisitor(writer: ClassWriter)
    ...
    override def visit(version: Int, access: Int, name: String, signature: String, superName: String, interfaces: Array[String]): Unit = {
      ...
      new CreateUpgradeIfRorPolicyNameMethod(this)
    }
  ...
  private class CreateUpgradeIfRorPolicyNameMethod(classVisitor: ClassVisitor) {
    private val methodVisitor = classVisitor.visitMethod(Opcodes.ACC_PRIVATE, "upgradeIfRorPolicyName", "(Ljava/lang/String;Lorg/elasticsearch/entitlement/runtime/policy/Scope;)Lorg/elasticsearch/entitlement/runtime/policy/Scope;", null, null)
