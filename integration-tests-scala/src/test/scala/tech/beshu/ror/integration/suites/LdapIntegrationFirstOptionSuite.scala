  ...
  override lazy val container = createLocalClusterContainer(
    EsClusterSettings(
      ...
      dependentServicesContainers = List(
        DependencyDef(name = "LDAP1", Coeval(new LdapContainer("LDAP1", "/ldap_integration_1st/ldapNew.ldif"))),
        DependencyDef(name = "LDAP2", Coeval(new LdapContainer("LDAP2", "/ldap_integration_1st/ldapNew.ldif"))),
      ),
