...
trait IndicesAliasesSuite
  ...
  "A search request" should {
    "return proper data" when {
      ...
      "restriced alias as wildcard called" in {
        eventually {
      ...
      "restriced alias as half wildcard called" in {
        eventually {
      ...
      "index can be access by admin using name or alias" in {
        eventually {
      ...
      "index can be access by admin using name or alias with wildcard" in {
        eventually {
      ...
      "index can be access by user perfmon using name or alias" in {
        eventually {
      ...
      "index can be access by user perfmon using name or alias with wildcard" in {
        eventually {
      ...
      "viet mian user should be able to access vietnam index" in {
        eventually {
      ...
      "viet mian user should be not able to access congo index" in {
        eventually {
      ...
      "viet mian user should be able to see allowed indices using alias" in {
        eventually {
