...
public class SSLNetty4InternodeServerTransport extends Netty4Transport {
  ...
  @Override
  public final ChannelHandler getServerChannelInitializer(String name, Settings settings) {
    return new SslChannelInitializer(name, settings);
  }

  public class SslChannelInitializer extends ServerChannelInitializer {
    private Optional<SslContext> context = Optional.empty();

    public SslChannelInitializer(String name, Settings settings) {
      super(name, settings);
