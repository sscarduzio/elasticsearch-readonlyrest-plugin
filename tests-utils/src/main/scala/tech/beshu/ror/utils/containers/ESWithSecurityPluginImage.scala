...
object ESWithSecurityPluginImage extends EsImage[EsWithSecurityPluginContainer.Config] {
  ...
  private val keystoreFileName = "ror-keystore.jks"
  private val bcfksKeystoreFileName = "ror-keystore.bcfks"
  private val truststoreFileName = "ror-truststore.jks"
  private val bcfksTruststoreFileName = "ror-truststore.bcfks"
