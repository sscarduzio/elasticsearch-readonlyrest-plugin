...
public class DocumentFieldReader extends FilterLeafReader {
  ...
  private final __old_FieldsSyncRule.FieldPolicy policy;
  ...
  public void document(int docID, StoredFieldVisitor visitor) throws IOException {
    super.document(docID, new StoredFieldVisitor() {
      ...
      public void binaryField(FieldInfo fieldInfo, byte[] value) throws IOException {
        ...
        Tuple<XContentType, Map<String, Object>> xContentTypeMapTuple = XContentHelper.convertToMap(new BytesArray(value), false);
