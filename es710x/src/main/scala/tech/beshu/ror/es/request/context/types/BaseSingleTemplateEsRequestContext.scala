...
abstract class BaseSingleTemplateEsRequestContext[R <: ActionRequest, T <: TemplateOperation : ClassTag](actionRequest: R,
                                                                                                         esContext: EsContext,
  ...
  override protected def modifyRequest(blockContext: TemplateRequestBlockContext): ModificationResult = {
    val templates = blockContext.getTemplateOperations
