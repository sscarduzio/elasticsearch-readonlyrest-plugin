...
public class DocumentFieldReader extends FilterLeafReader {
  private static final Logger logger = Loggers.getLogger(DocumentFieldReader.class, DocumentFieldReader.class.getName());
  ...
  public PointValues getPointValues(String field) throws IOException {
    return policy.canKeep(field) ? in.getPointValues(field) : null;
  }

  @Override
  public Terms terms(String field) throws IOException {
    return policy.canKeep(field) ? in.terms(field) : null;
  }
