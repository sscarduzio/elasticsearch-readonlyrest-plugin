...
class RequestInfo(channel: RestChannel, taskId: Long, action: String, actionRequest: ActionRequest,
                  clusterService: RorClusterService, threadPool: ThreadPool, remoteClusterService: Option[RemoteClusterService])
  ...
  override val extractHasRemoteClusters: Boolean = remoteClusterService.exists(_.isCrossClusterSearchEnabled)
