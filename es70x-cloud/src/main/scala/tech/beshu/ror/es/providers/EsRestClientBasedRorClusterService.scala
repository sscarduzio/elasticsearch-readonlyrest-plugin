...
import tech.beshu.ror.es.providers.RorClusterService.{AliasName, IndexName, IndexOrAlias, IndexPatten, IndexUuid, TemplateName}
import scala.collection.JavaConverters._

class EsRestClientBasedRorClusterService(client: RestHighLevelClient) extends RorClusterService {
